...
from ppstructure.table.predict_table import extract_to_html
...
def html_extractor(img_path, output_dir):
    html_path = extract_to_html(img_path, output_dir)
    return html_path
...
def main():
    ...
    for img_path in image_file_list:
        ...
        if args.type == "ocr":
            result = engine.ocr(
                img_path, det=args.det, rec=args.rec, cls=args.use_angle_cls
            )
